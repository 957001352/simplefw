package com.fw.web.basic.service;

import com.fw.domain.BaseFile;
import com.fw.domain.Result;
import com.fw.web.basic.service.fbk.AttachmentServiceFbk;
 ...
 * @Date 2020/3/31
 */
@FeignClient(value = "fw-service/attachment", fallback = AttachmentServiceFbk.class,configuration = FeignMultipartConfig.class)
