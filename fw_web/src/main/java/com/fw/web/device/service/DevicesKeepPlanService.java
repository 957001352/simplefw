...
import com.fw.web.device.service.fbk.DevicesKeepPlanServiceFbk;
 ...
 * @date 2020/10/21
 */
@FeignClient(value = "fw-service/devicesKeepPlan", fallback = DevicesKeepPlanServiceFbk.class)
public interface DevicesKeepPlanService {
     ...
     */
    @PostMapping("/save")
    Result save(@RequestBody DevicesKeepPlan devicesKeepPlan);
    ...
    Result getDevicesKeepPlan(@RequestParam(value = "id") Integer id);
