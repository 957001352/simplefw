...
/**
 * @Description 日精机7521-注塑成型工艺卡
 * @Author gchen
 * @Date 2020/11/4
 */
@Data
@ApiModel(value = "riJingJiTwo", description = "日精机7521-注塑成型工艺卡")
public class RiJingJiTwo extends CardCommParams implements Serializable {
    /**
     * 射出
     */
    ...
    private String lowSpeedStressSite;
    /**
     * 合模 高速位置
     */
    @ApiModelProperty(value = "合模 高速位置")
    private String highSpeedSite;
    /**
     * 合模 低压
     */
     ...
     * 开模 高速1位置
     */
    @ApiModelProperty(value = "开模 高速1位置")
    private String highSpeedOneSite;
    /**
     * 保压 Pp1
     */
     ...
     * 推顶 前进限度
     */
    @ApiModelProperty(value = "推顶 前进限度")
     ...
     * 温度 筒头
     */
    @ApiModelProperty(value = "温度 筒头")
    private String canisterHead;
    /**
     * 温度 前部
     */
